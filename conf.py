...
BLOG_AUTHOR = "CompositeLearning"  # (translatable)
BLOG_TITLE = "Practical Machine Learning Course"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://compositelearning.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://compositelearning.com/"
BLOG_EMAIL = "denis.akhiyarov@gmail.com"
BLOG_DESCRIPTION = "Practical Machine Learning Course by Denis Akhiyarov and Ruslan Ishkildin"  # (translatable)
